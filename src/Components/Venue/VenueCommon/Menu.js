        ...
        <Row className="g-4 g-md-0 align-items-center">
          ...
          <Col md={6}>
            <div className="menu_content">
              <p>
                Our chefs are busy preparing our 2023 menus. Please find a
                sample menu below: *
              </p>
              <p>
        ...
        <div className="one_feed_banner">
          ...
          <div className="one_feed_content">
            ...
            <p>
              ...
              our 2023 Christmas parties. For every guest we cater for, we
              donate the cost of a school meal to a child living in some of the

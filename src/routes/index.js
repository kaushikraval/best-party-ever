...
const Vacancies = lazy(() => import('Components/About/Vacancies'));
const Sustainability = lazy(() => import('Components/About/Sustainability'));
const Privacy = lazy(() => import('Components/About/Privacy'));
const Feedback = lazy(() => import('Components/About/Feedback'));
const BookingTerms = lazy(() => import('Components/About/BookingTerms'));
    ...
    <Suspense fallback={<Loader />}>
      <div className="main_wrapper">
        ...
        <Routes>
          ...
          <Route path="/christmas-parties-london" element={<London />} />
